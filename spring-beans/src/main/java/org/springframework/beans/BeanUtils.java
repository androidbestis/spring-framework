...
public abstract class BeanUtils {
	...
	public static <T> T instantiateClass(Class<T> clazz) throws BeanInstantiationException {
		...
		try {
			//getXXX(): 这些对象反映此 Class 对象所表示的类或接口（包括那些由该类或接口声明的以及从超类和超接口继承的那些的类或接口）的公共 member 方法
			//getDeclaredXXX(): 这些对象反映此 Class 对象表示的类或接口声明的所有方法，包括公共、保护、默认（包）访问和私有方法，但不包括继承的方法。
			//初始化（instantiate）类
